...
highest_cases_in_each_state <- group_by()
...
# Save as `lowest_deaths_in_each_state`
  lowest_deaths_in_each_state <- group_by()
...
# how many rows and columns are in the states data? 
#

#  Write code (at least 2-3 lines) that will answer your question
my_answer <- nrow(states)
ncol(states)
